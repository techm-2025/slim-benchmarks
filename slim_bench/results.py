"""Shared result and summary-stats shapes for every transport leg.

Kept free of any transport dependency (no slim_bindings, no http) so both the
SLIM and HTTP harnesses can emit the same JSON for direct comparison.
"""
